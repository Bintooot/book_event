...
import bdays from '../assets/bdays.jpg'
...
const Birthday = () => {
    ...
    return (
        <div>
            <Navbar />
            <main>
                <div style={{ backgroundImage: `url(${bdays})` }} className='w-full bg-cover bg-center h-[80vh] text-white flex justify-center text-center items-center text-5xl font-serif'>
                ...
                <div className=' text-white bg-nav-bg-color flex md:flex-row flex-col w-full'>
                    <div className='md:w-1/2 w-full bg-cover bg-center justify-evenly p-8 flex flex-col text-center' style={{ backgroundImage: `url(${bday})` }}>
                        {FullPlan}
                        {Fullinfo}
